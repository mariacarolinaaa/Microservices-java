...
import br.edu.atitus.currency_service.CurrencyServiceApplication;
import br.edu.atitus.currency_service.clients.CurrencyBCClient;
import br.edu.atitus.currency_service.clients.CurrencyBCFallback;
...
public class CurrencyController {
    ...
    private final CurrencyBCFallback currencyBCFallback;

    private final CurrencyServiceApplication currencyServiceApplication;
	
	private final CurrencyRepository repository;
	private final CurrencyBCClient currencyBCClient;
	private final CacheManager cacheManager;
	
	public CurrencyController(CurrencyRepository repository, CurrencyBCClient currencyBCClient, CurrencyServiceApplication currencyServiceApplication, CacheManager cacheManager, CurrencyBCFallback currencyBCFallback) {
		super();
		this.repository = repository;
		this.currencyBCClient = currencyBCClient;
		this.currencyServiceApplication = currencyServiceApplication;
		this.cacheManager = cacheManager;
		this.currencyBCFallback = currencyBCFallback;
	}
